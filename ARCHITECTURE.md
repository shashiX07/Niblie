...
│  │  - Detects college URL patterns                       │  │
│  │  - Loads appropriate college scripts                  │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                              │
│  ┌──────────────────────────────────────────────────────┐  │
│  │  colleges/[college-code]/login.js                     │  │
│  │  - Auto-fill credentials                              │  │
│  │  - Learn credentials on first use                     │  │
│  │  - Handle security questions                          │  │
│  │  - Store in formAutofiller format                     │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                              │
│  📚 See colleges/README.md for adding new colleges          │
└─────────────────────────────────────────────────────────────┘
```
...
**Framework:** Extensible system for college portal automation  
**Storage:** Uses `autofillFields` array (key/value structure)  
**Security:** Browser-based sync storage, no external servers  
**Adding Colleges:** See [colleges/README.md](colleges/README.md)
